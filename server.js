...
// static page, a health endpoint and a version endpoint, the same role
// `expo init`/`tauri create` play for their targets — a genuine starting
// point a new project can build on immediately, not placeholder content.
//
